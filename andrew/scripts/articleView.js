...
// This function is called on the new.html page because we want the things that this function is doing to happen on that page.
...
articleView.create = () => {
  ...
  let newArticle; //eslint-disable-line
  $('#articles').empty();
  ...
  console.log(newArticle.publishedOn);
